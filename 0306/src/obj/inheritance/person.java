...
public class person {
	...
	//Object 메소드 오버라이드 hashCode() - 객체 동등 비교를 위해서 생성하는 메소드
	@Override
	public int hashCode() { 	
		//특정 값을 기준으로 확인하기 위해 메소드 수정
		final int prime = 31;
		int res =1;
		res = prime * res + age;
		res = prime * ((name==null) ?  0 : name.hashCode());
	return res;
	}
	@Override
	public boolean equals(Object obj) {
		...
		if(age != other.age) return false;	//객체 내의 age멤버의 값을 비교 확인
		if (name == null) {
			if(other.name != null) {
				return false;				
			}
