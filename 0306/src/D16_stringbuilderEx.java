...
public class D16_stringbuilderEx {
	...
	public static void main(String[] args) {
		...
		// 1. append - () 안의 값을 문자열 뒤에 추가
		sb.append(10);
		System.out.println("append의 결과 : " + sb);
		sb.append(true);
		System.out.println("append의 결과 : " + sb);
		...
		// 4. deleteCharAt() - 인덱스 위치에 있는 문자 삭제
		sb.deleteCharAt(12);
		...
		// 6. replace() - 문자열 교체
		sb.replace(12, 14, "! 1");
		System.out.println("sb.replace(12, 14, \"! 1\")의 결과 : " + sb);
		// 7. reverse() - 문자열의 순서를 반대로
		sb.reverse();
		System.out.println("sb.reverse() 의 결과 : " + sb);
	}
