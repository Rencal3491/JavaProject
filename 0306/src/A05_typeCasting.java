...
public class A05_typeCasting {
	...
	public static void main(String[] args) {
		// 타입캐스팅 : 어떠한 변수 혹은 값을 강제로 다른 타입으로 변환시키는 것
		...
		// int i = f;
		// int i = a;
		// 타입 캐스팅을 통하여 값을 억지로 넣어 줄 수 있음
		// 그러나 타입 캐스팅을 하면 값이 손실이 일어날 수 있다
		int i = (int) f;
		...
		// 그 정수 값 중에 0~127까지의 값들을 ASCII 코드라고 부른다
		
		// char 타입 변수에 65를 넣는것과 'A'를 넣는것은 같다
		char ch = 97;
		System.out.println(ch);
		ch = 'A';
		System.out.println(ch);
		
		//int 타입 값을 char 타입으로 캐스팅하면 해당하는 아스키코드 문자로 변환됨
		int c = 97;
